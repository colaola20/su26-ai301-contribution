...
I chose this issue because I'm familiar with a tech stack, and the issue seams doable for the class duration. Additionally, the mantainer are active and responding and leaving comments on pull request page. The repository has a good documentation including documentation on how to contribute.
